...
tester_params = {
    'model_folder': "Test_bsdef",
    'save_folder': "Test_bsdef", # Where to save results
    'metrics': ["MAE", "FME", "KLD"], # MAE, FME, LinfLinf, L2Linf, KLD, NLL
    'n_samples': 5*10 ** 0, 
    "Grid-based": True, # How to calculate metrics
...
def _print_config():
    ...
    logger.info('Deep Filter: {}'.format("BSDEF"))
    ...
    logger.info('bsdef_params: {}'.format(bsdef_params))
